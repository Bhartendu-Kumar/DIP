...
def reading_viola_jones():

    #file name : ViolaJones_analysis_results.csv
    with open(join('.', 'ViolaJones_analysis_results.csv'), 'r') as csvfile:
...
def performance_analysis_face(dataset_dict , dataset_name , parameter_name):
    ...
    ##
    #confidence scores
    level_weights = ast.literal_eval(dataset_dict['level_weights'])
...
def absolute_metrics_to_relative_metrics(dictionary):
    ...
    for data_set in viola_data_set_names:
        ...
        final_dataset_dict['avg_pre_processing_time'] = percentage_increase((viola_dataset_dict['avg_pre_processing_time']) , (current_dataset_dict['avg_pre_processing_time']))
        final_dataset_dict['avg_classification_time'] = percentage_increase((viola_dataset_dict['avg_classification_time']) , (current_dataset_dict['avg_classification_time']))
        final_dataset_dict['avg_total_time'] = percentage_increase((viola_dataset_dict['avg_total_time']) , (current_dataset_dict['avg_total_time']))
        final_dataset_dict['avg_level_weights'] = percentage_increase((viola_dataset_dict['avg_level_weights']) , (current_dataset_dict['avg_level_weights']))
        final_dataset_dict['std_level_weights'] = percentage_increase((viola_dataset_dict['std_level_weights']) , (current_dataset_dict['std_level_weights']))
